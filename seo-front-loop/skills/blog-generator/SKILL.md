...
4. 主题通过业务相关性、读者需求、搜索意图、可提供的独有材料、可执行性和重复风险排序。搜索量、Keyword Difficulty、竞品流量和模型评分只能作为证据的一部分，不能代替读者任务或产品事实。
...
先选读者任务，再选文章结构。教程、诊断、比较、案例、核查与观点文章使用不同推进顺序。统一要求是：读者快速认出问题，尽早得到有用信息，看见依据，理解如何行动，并知道合理的下一步。
